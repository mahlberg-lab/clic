...
want to display, such as "Sentences", and the "Quote" and "Non-quote"
subsets, etc. :numref:`figure-analysis-texts` illustrates the annotation
views for quotes, short suspensions and long suspensions in *Pride and
Prejudice*.
