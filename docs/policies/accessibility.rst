...
We aim to make the CLiC website as easy to use and as accessible as possible for all users. Our aim is that the site will meet the recommended government standard for web accessibility ##TODO(WCAG 2.1 AA). This means that you should be able to:
