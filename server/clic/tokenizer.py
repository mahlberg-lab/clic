...
* The "Rule Status value" of the boundary according to ICU (see [ICU_Rule_Status_Values]_) is at the end of a word (e.g. after ``jump``) or the end of a number (e.g. after ``32.3``).
